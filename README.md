...
_See code: [src/commands/build.js](https://github.com/corpcode/arena-plugin/blob/v0.0.24/src/commands/build.js)_
...
_See code: [src/commands/dev.js](https://github.com/corpcode/arena-plugin/blob/v0.0.24/src/commands/dev.js)_
...
_See code: [src/commands/init.js](https://github.com/corpcode/arena-plugin/blob/v0.0.24/src/commands/init.js)_
...
_See code: [src/commands/install.js](https://github.com/corpcode/arena-plugin/blob/v0.0.24/src/commands/install.js)_
...
_See code: [src/commands/selfhost.js](https://github.com/corpcode/arena-plugin/blob/v0.0.24/src/commands/selfhost.js)_
<!-- commandsstop -->
