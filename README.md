...
arena-plugin-cli/0.0.13 darwin-x64 node-v8.12.0
...
_See code: [src/commands/dev.js](https://github.com/corpcode/arena-plugin/blob/v0.0.13/src/commands/dev.js)_
...
_See code: [src/commands/init.js](https://github.com/corpcode/arena-plugin/blob/v0.0.13/src/commands/init.js)_
...
_See code: [src/commands/selfhost.js](https://github.com/corpcode/arena-plugin/blob/v0.0.13/src/commands/selfhost.js)_
<!-- commandsstop -->
